...
public interface LAListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LAParser#mais_contantes}.
	 * @param ctx the parse tree
	 */
	void enterMais_contantes(LAParser.Mais_contantesContext ctx);
	/**
	 * Exit a parse tree produced by {@link LAParser#mais_contantes}.
	 * @param ctx the parse tree
	 */
	void exitMais_contantes(LAParser.Mais_contantesContext ctx);
	/**
